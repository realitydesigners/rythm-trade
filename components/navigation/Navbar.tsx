	...
	return (
		...
		>
			...
			>
				...
				<Link href="/">
					<div
						className={`${space.className}  hidden flex-col pb-2 pt-2 text-gray-200 lg:flex `}
					>
			...
			>
				<div className="flex  w-auto ">
					<p
						className={`${sirin.className} text-center  text-[12px] tracking-wide  text-gray-600 hover:text-gray-400`}
					>
				...
				<ul className="lg:space-evenly flex-cols mt-4 gap-4  lg:mt-0 lg:flex">
					<li className="block">
						<Link
							href="/dashboard"
							className={`${space.className} flex  items-center rounded-lg  p-2 text-3xl font-bold   uppercase  tracking-wide text-gray-200 transition-all duration-200 ease-in-out hover:scale-105 hover:bg-gray-600/10 hover:text-gray-200 lg:text-sm`}
							onClick={closeNav}
						>
					...
					<li className="block">
						<Link
							href="/account"
							className={`${space.className}  flex  items-center rounded-lg p-2 text-3xl font-bold font-bold  uppercase   tracking-wide text-gray-200 transition-all duration-200 ease-in-out hover:scale-105 hover:bg-gray-600/10 hover:text-gray-200 lg:text-sm`}
							onClick={closeNav}
						>
				...
				<div className="hidden  w-auto  lg:flex ">
					<p
						className={`${sirin.className} text-center  text-[12px] tracking-wide text-gray-600 underline hover:text-gray-400`}
					>
						rythm.capital
					</p>
				</div>
