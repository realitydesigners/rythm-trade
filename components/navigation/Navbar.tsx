			...
			>
				...
				<ul className="lg:space-evenly flex-cols mt-4 gap-4  lg:mt-0 lg:flex">
					<li className="block">
						<Link
							href="/dashboard"
							className={`${space.className} flex  items-center rounded-lg  p-2 text-3xl font-semibold   uppercase  tracking-wide text-gray-200 transition-all duration-200 ease-in-out hover:scale-105 hover:bg-gray-600/10 hover:text-gray-200 lg:text-sm`}
							onClick={closeNav}
						>
