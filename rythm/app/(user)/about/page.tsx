   ...
   return (
      <>
         <div className="flex flex-col justify-center items-center w-full min-h-screen p-6 text-center">
            <h1 className={`${staatliches.className}  text-white text-5xl lg:text-6xl font-bold mb-8`}>Welcome to Rythm</h1>
            <p className={`${jura.className}  text-gray-300 text-lg max-w-2xl mx-auto`}>Rythm is a cutting-edge trading algorithm designed to revolutionize the way you interact with the financial markets. Using state-of-the-art technology, Rythm analyzes market patterns to help make informed decisions that propel you towards a profitable future.</p>
            <div className="mt-10">
               <div className="pt-8 ">
