...
import { BoxModel, MasterPosition, MasterProfile, ResoModel, Stream } from '@/app/components/index';
import {
    Button,
    Dialog,
    DialogContent,
...
import { fetchFavoritePairs, fetchInstruments, updateFavoritePairs } from '../../api/rest';
