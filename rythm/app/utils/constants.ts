...
export const BOX_SIZES: Record<string, number[]> = {
   // 25%
   1: [10, 13, 17, 23, 31, 42, 56, 75, 100, 133, 177, 237, 316, 421, 562, 750, 1000],

   // 10.0%
   2: [10, 11, 12, 13, 14, 16, 17, 19, 21, 23, 25, 28, 31, 34, 37, 41, 45, 50, 55, 61, 67, 74, 81, 89, 98, 108, 119, 131, 144, 158, 174, 191, 211, 232, 255, 281, 309, 340, 374, 411, 452, 497, 547, 602, 662, 728, 801, 881, 970, 1067, 1173, 1291, 1420, 1562, 1718, 1890, 2079, 2287, 2516, 2767, 3044],

   // IntraDay
   3: [10, 11, 12, 14, 16, 18, 20, 23, 26, 29, 32, 36, 41, 46, 52, 59, 67, 75, 84, 95, 107, 121, 136, 153, 173, 194, 218],
   // 12.5%
   // d: [1000, 875, 765, 669, 586, 512, 448, 392, 343, 300, 263, 230, 200, 176, 154, 134, 118, 103, 90, 79, 69, 60, 52, 46, 40, 35, 31, 27, 23, 20, 18, 16, 14, 12, 11, 19],

   d: [200, 176, 154, 134, 118, 103, 90, 79, 69, 60, 52, 46, 40, 35, 31, 27, 23, 20],
};
