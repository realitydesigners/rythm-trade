  ...
  const renderToggleButtons = () => {
    return (
      <div className={styles.buttonContainer}>
        <button
          onClick={() => switchBoxArray('default')}
          className={`${styles.toggleButton} ${
            selectedBoxArray === 'default' ? styles.active : ''
          }`}
        >
          MysticRex
        </button>
        <button
          onClick={() => switchBoxArray('array1')}
          className={`${styles.toggleButton} ${
            selectedBoxArray === 'array1' ? styles.active : ''
          }`}
        >
          SpiritBronto
        </button>
        <button
          onClick={() => switchBoxArray('array2')}
          className={`${styles.toggleButton} ${
            selectedBoxArray === 'array2' ? styles.active : ''
          }`}
        >
          ZenSaur
        </button>
        <button
          onClick={() => switchBoxArray('array3')}
          className={`${styles.toggleButton} ${
            selectedBoxArray === 'array3' ? styles.active : ''
          }`}
        >
          AuraRaptor
        </button>
    ...
    <div className={styles.container}>
      {initializationComplete ? (
        <>
          ...
          {renderToggleButtons()}
          <div>
            <span className={styles.title}>Current Close Price:</span>{' '}
            {currentClosePrice}
          </div>
