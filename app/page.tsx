		...
		<>
				...
				<div className="relative flex h-full w-full items-center justify-center">
					...
					<div className="z-20 flex w-full flex-col items-center justify-center space-y-4 p-8 md:flex-row md:space-x-4 md:space-y-0 lg:w-11/12 ">
						<div className="flex w-full flex-col items-center rounded-lg lg:w-1/2 lg:items-start   ">
							<h1
								className={`${space.className}  inline-block bg-gradient-to-r from-purple-200 via-purple-100 to-indigo-200 bg-clip-text text-6xl uppercase leading-[.8em] text-transparent lg:text-9xl  lg:leading-[.8em]`}
							>
								TRADING IN
								<br /> ANOTHER
								<br />
			...
			<section className="bg-black py-12 pt-20 lg:px-20 ">
				<div className="w-full px-4 md:px-20 ">
					<h2
						className={`${space.className} bg-gradient-to-r from-purple-200 via-purple-100 to-indigo-200 bg-clip-text py-20 text-center text-6xl uppercase leading-[.8em] text-transparent  lg:text-6xl lg:leading-[.8em] `}
					>
						A New Kind Of
