...
function MasterPosition({ positionData }: MasterPositionProps) {
	return (
		<div className="w-full overflow-x-auto  border-gray-600/50 rounded-lg border shadow-2xl ">
			<table className="min-w-full table-auto border-collapse bg-black shadow-lg">
				...
				<tbody className="text-xs font-mono">
					{positionData.map((position, index) => (
						...
						>
							<td className="px-4 py-2 text-left border-b border-gray-600/50">
							...
							<td className="px-4 py-2 text-right border-b border-gray-600/50">
								{position.long.units !== "0"
									? position.long.units
									: position.short.units !== "0"
